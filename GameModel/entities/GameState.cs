...
namespace FireAndManeuver.GameModel
{
    ...
    public class GameState
    {
        ...
        public static GameState Clone(GameState ge)
        {
            // Cheat!
            XmlSerializer srz = new XmlSerializer(typeof(GameState));
            ...
            var newGE = GameState.LoadFromStream(ms);

            return newGE;
        }

        public static GameState ResolveVolley(GameState ge, IConfigurationRoot config, int volley, string sourceFileName)
        {
            ge.Volley = volley;
        ...
        public static void RecordVolleyReport(GameState ge, string originalSourceFile, string destinationFolder)
        {
        ...
        public static void RecordExchangeReport(GameState ge, string originalSourceFile)
        {
