...
namespace FireAndManeuver.GameModel
{
    ...
    public class HullSystem : DefenseSystem
    {
        ...
        [XmlAttribute("type")]
        public HullTypeLookup HullType { get; set; }
        ...
        {
            string typeDetail = this.HullType == HullTypeLookup.Custom ? "Custom" : string.Format("{0} [TMFx{1}]", System.Enum.GetName(typeof(HullTypeLookup), this.HullType), this.HullTypeMultiplier);
